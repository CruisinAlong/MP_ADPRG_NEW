...
PlayerMovement::PlayerMovement(std::string name) : AbstractComponent(name, Script), projectilePool(nullptr), isJumping(false), jumpSpeed(300.0f), gravity(500.0f), velocityY(0.0f), playerHeight(30.0f) { // Assuming player height is 50.0f
